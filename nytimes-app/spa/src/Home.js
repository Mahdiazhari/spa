...
let specialtyURL = "https://api.nytimes.com/svc/search/v2/articlesearch.json";
...
class Home extends Component {
    render() {
      return (
        <div>
          <h2>NYT Loader</h2>
          <p>Search Articles using the search function</p>
        </div>
      );
    }
  }
...
class Articles extends React.Component  {
  ...
  class Input extends React.Component {
    ...
    constructor(props) {
      ...
      this.state = {
        userInput: "",
        apiKey: "N3ngqVL72vZeZfA6GT6Ey8fZJtmU6oDu",
        articles: [],
        movies: [],
        searchType: "articles"
      };
